...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/12 19:35:16 by syamasaw          #+#    #+#             */
/*   Updated: 2024/02/12 19:39:10 by syamasaw         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	push_data(t_data *data, t_data *work, t_var vars)
{
	...
	while (++k <= vars.right)
	{
		if (work[i].info.st_mtime < work[j].info.st_mtime)
			data[k] = work[j--];
		else if (work[i].info.st_mtime == work[j].info.st_mtime)
		{
